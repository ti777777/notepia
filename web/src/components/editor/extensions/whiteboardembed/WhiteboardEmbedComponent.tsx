...
import { PenLine, ChevronUp, ChevronDown, ExternalLink, Trash2 } from "lucide-react"
...
const WhiteboardEmbedComponent: React.FC<NodeViewProps> = ({ node, updateAttributes, selected, editor, deleteNode, getPos }) => {
      ...
      >
        ...
        {isEditable && (showActions || selected) && (
          <div className="absolute top-2 right-2 flex gap-1 z-50">
            ...
            <button onClick={() => navigate(`/workspaces/${workspaceId}/whiteboard/${viewId}`)} className="p-2 bg-white dark:bg-neutral-800 hover:bg-gray-100 dark:hover:bg-neutral-700 rounded-lg shadow-lg border border-gray-200 dark:border-neutral-600 transition-colors" title="Open full view">
...
export default WhiteboardEmbedComponent
